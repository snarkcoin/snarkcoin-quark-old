...
#if defined(NDEBUG)
#error "snarkcoin cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 0) {
        nSubsidy = 50 * COIN;
    } else if (nHeight <= 209999 && nHeight >= 1) {
        nSubsidy = 50 * COIN;
    } else if (nHeight <= 419999 && nHeight >= 210000) {
        nSubsidy = 25 * COIN;
    } else if (nHeight <= 629999 && nHeight >= 420000) {
        nSubsidy = 12.5 * COIN;
    } else if (nHeight <= 839999 && nHeight >= 630000) {
        nSubsidy = 6.25 * COIN;
...
{
    RenameThread("snarkcoin-scriptch");
