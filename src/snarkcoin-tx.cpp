...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("snarkcoin Core snarkcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  snarkcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded snarkcoin transaction") + "\n" +
                               "  snarkcoin-tx [options] -create [commands]   " + _("Create hex-encoded snarkcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded snarkcoin transaction
