                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Snarkcoin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a snarkcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and snarkcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About snarkcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about snarkcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for snarkcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your snarkcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified snarkcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a snarkcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the snarkcoin Core help message to get a list with possible snarkcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("snarkcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to snarkcoin network", "", count));
}
...
{
    QString strTitle = tr("snarkcoin Core"); // default title
