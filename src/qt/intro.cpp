...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("snarkcoin Core"),
     ...
     * override -datadir in the snarkcoin.conf file in the default data directory
     * (to be consistent with snarkcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
