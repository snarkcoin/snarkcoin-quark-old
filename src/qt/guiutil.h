...
/** Utility functions used by the snarkcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render snarkcoin addresses in monospace font
...
// Parse "snarkcoin:" URI into recipient object, return true on successful parsing
