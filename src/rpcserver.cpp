...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop snarkcoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "snarkcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* snarkcoin features */
        {"snarkcoin", "masternode", &masternode, true, true, false},
        {"snarkcoin", "masternodelist", &masternodelist, true, true, false},
        {"snarkcoin", "mnbudget", &mnbudget, true, true, false},
        {"snarkcoin", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"snarkcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"snarkcoin", "mnsync", &mnsync, true, true, false},
        {"snarkcoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"snarkcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use snarkcoind, or the -server option to snarkcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> snarkcoin-cli " + methodname + " " + args + "\n";
}
