snarkcoin Core version 2.3.0 is now available from:

  <https://github.com/snarkcoin-project/snarkcoin/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/snarkcoin-project/snarkcoin/issues>

Compatibility
==============

snarkcoin Core is extensively tested on multiple operating systems using
...
snarkcoin Core should also work on most other Unix-like systems but is not
...
[
  {
    ...
    winner: {
        address: addr,    (string) snarkcoin MN Address,
...
[
  {
    ...
    "addr": addr,      (string) Masternode snarkcoin address
...
snarkcoin Core now enables bloom filters by default to support SPV clients like mobile wallets. This feature can be disabled by using the `-peerbloomfilters` option on startup.
...
- #195 `aee05fe` [ZMQ] ZMQ integration for snarkcoin (Mrs-X)
...
### Tests and QA
- #191 `3a778c3` [Tests] Fix the unit test suite for use with snarkcoin (Fuzzbawls)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/snarkcoin-project-translations/).
