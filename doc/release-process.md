...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/snarkcoin-Project/snarkcoin/blob/master/doc/translation_process.md#synchronising-translations).
...
### Build and sign snarkcoin Core for Linux, Windows, and OS X:
    ...
    pushd ./gitian-builder
    ./bin/gbuild --memory 3000 --commit snarkcoin=v${VERSION} ../snarkcoin/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gbuild --memory 3000 --commit snarkcoin=v${VERSION} ../snarkcoin/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gbuild --memory 3000 --commit snarkcoin=v${VERSION} ../snarkcoin/contrib/gitian-descriptors/gitian-osx.yml
