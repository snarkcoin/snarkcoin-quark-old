...
This mechanism has been integrated into Bitcore-Node-snarkcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/snarkcoin-Project/insight-api-snarkcoin#web-socket-api](https://github.com/snarkcoin-Project/insight-api-snarkcoin#web-socket-api) 
* API: [https://github.com/snarkcoin-Project/insight-api-snarkcoin#swifttx-transactions](https://github.com/snarkcoin-Project/insight-api-snarkcoin#swifttx-transactions) 
...
By default, the snarkcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the snarkcoin Core daemon:
