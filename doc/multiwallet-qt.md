...
In order to support loading of multiple wallets in snarkcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is snarkcoin.cpp.
...
Changes to snarkcoin.cpp
----------------------
snarkcoin.cpp is the entry point into snarkcoin-qt, and as such, will require some minor modifications to provide hooks for
