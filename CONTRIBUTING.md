Contributing to snarkcoin Core
============================

The Snarkcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the snarkcoin Core project, and is not to be
confused with overall snarkcoin Network Protocol consensus changes.

Whether a pull request is merged into snarkcoin Core rests with the project merge
...
Patches that change snarkcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the snarkcoin consensus, it must have been
...
The project leader is the release manager for each snarkcoin Core release.
